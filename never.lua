...
-- Helper function to make buttons work on mobile
local function MakeMobileCompatible(button, callback)
    -- Support both mouse clicks and touch taps
...
function Neverlose_Main:Window(config)
    ...
    -- Make LoadButton work on mobile
    MakeMobileCompatible(LoadButton, function()
    ...
    MakeMobileCompatible(Settings, function()
    ...
    MakeMobileCompatible(Search, function()
        ...
        function Tabs:Tab(title)
            ...
            function Sections:Section(title)
                ...
                function Elements:Button(title, callback)
                    ...
                    MakeMobileCompatible(Button, function()
                        Neverlose_Main:PlaySound(Neverlose_Main.Lib_Sounds.ClickSound)
                        pcall(callback)
                    end)
                    Section.Size = UDim2.new(0, 285, 0, SectionLayout.AbsoluteContentSize.Y + 10)
                ...
                function Elements:Toggle(title, callback)
                    ...
                    MakeMobileCompatible(Toggle, function()
                        Neverlose_Main:PlaySound(Neverlose_Main.Lib_Sounds.ClickSound)
                        Toggled = not Toggled
                ...
                function Elements:Dropdown(title, list, callback)
                    ...
                    MakeMobileCompatible(Dropdown, function()
                        Neverlose_Main:PlaySound(Neverlose_Main.Lib_Sounds.ClickSound)
                    ...
                    for i,v in pairs(list) do
                        ...
                        MakeMobileCompatible(Item, function()
                            Neverlose_Main:PlaySound(Neverlose_Main.Lib_Sounds.ClickSound)
                            Dropfunc:Set(v)
                            TweenService:Create(
                                DropdownFrameHold,
